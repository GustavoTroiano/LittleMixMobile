...
import com.example.littlemixmobile.api.MercadoPagoService;
import com.example.littlemixmobile.databinding.ActivityUsuarioPagamentoPedidoBinding;
...
public class UsuarioPagamentoPedidoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityUsuarioPagamentoPedidoBinding binding = ActivityUsuarioPagamentoPedidoBinding.inflate(getLayoutInflater());
    ...
    private void configJSON() {
        ...
        JsonObject removerPix = new JsonObject();
        removerPix.addProperty("id", "pix");
        ...
        excluded_payment_methods.add(removerPix);
