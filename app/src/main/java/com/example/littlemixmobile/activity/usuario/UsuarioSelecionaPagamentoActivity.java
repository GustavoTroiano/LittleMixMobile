...
import com.example.littlemixmobile.adapter.UsuarioPagamentoAdapter;
import com.example.littlemixmobile.databinding.ActivityUsuarioSelecionaPagamentoBinding;
...
public class UsuarioSelecionaPagamentoActivity extends AppCompatActivity implements UsuarioPagamentoAdapter.OnClick {
    ...
    private void recuperaFormaPagamento(){
        DatabaseReference pagamentoRef = FirebaseHelper.getDatabaseReference().child("formapagamento");
